...
class PerampunganControllerr extends Controller
{
    ...
    public function edit($id_perampungan)
    {
        ...
        ->leftjoin('tb_payroll_detail_perampungan', 'tb_payroll_detail_gaji.id_pegawai', 'tb_payroll_detail_perampungan.id_pegawai')
        ->whereIn('tb_payroll_detail_gaji.id_pegawai', $tes)->groupBy('id_pegawai')
