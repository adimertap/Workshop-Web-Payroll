...
class PerampunganControllerr extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $tes = DetailPerampungan::leftjoin('tb_payroll_perampungan','tb_payroll_detail_perampungan.id_perampungan','tb_payroll_perampungan.id_perampungan')
        ->where('id_perampungan','=', $perampungan->id_perampungan)->pluck('id_pegawai','masa_perolehan_awal','masa_perolehan_akhhir');
