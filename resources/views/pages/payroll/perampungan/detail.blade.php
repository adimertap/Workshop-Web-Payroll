    ...
    <div id="gaji">
        ...
        <div class="container">
            <div class="card card-collapsable mb-4">
                <a class="card-header collapsed" href="#collapseCardExample-{{ $item->Pegawai->id_pegawai }}"
                ...
                <form action="{{ route('gaji-pegawai.store') }}" method="POST" id="form2-{{ $item->Pegawai->id_pegawai }}"
                    class="d-inline">
                    @csrf
