    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h6 class="mt-2">A. IDENTITAS PENERIMA PENGHASIL YANG DIPOTONG</h6>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="npwp_terpotong" class="col-sm-2 col-form-label col-form-label-sm">1. NPWP</label>
                                <div class="col-sm-8">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="status_pegawai" class="col-sm-3 col-form-label col-form-label-sm">6. Status/Jumlah Tanggungan Keluarga</label>
                                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="nik_terpotong" class="col-sm-2 col-form-label col-form-label-sm">2. NIK/No Paspor</label>
                                <div class="col-sm-8">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="nama_jabatan" class="col-sm-3 col-form-label col-form-label-sm">7. Nama Jabatan</label>
                                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="nama_pegawai" class="col-sm-2 col-form-label col-form-label-sm">3. Nama</label>
                                <div class="col-sm-8">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="karyawan_asing" class="col-sm-3 col-form-label col-form-label-sm">8. Karyawan Asing</label>
                                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="alamat_pegawai" class="col-sm-2 col-form-label col-form-label-sm">4. Alamat</label>
                                <div class="col-sm-8">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="kode_negara" class="col-sm-3 col-form-label col-form-label-sm">9. Kode Negara Domisili</label>
                                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <label for="jenis_kelamin" class="col-sm-2 col-form-label col-form-label-sm">5. Jenis Kelamin</label>
                                <div class="col-sm-8">
