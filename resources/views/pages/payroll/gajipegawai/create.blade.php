    ...
    function tambahtunjangan(event, id_pegawai) {
        ...
        if (gajikenapajak <= pph1) {
            ...
            if (pphlevel1bulan < 0) {
                ...
                var jumlahfix3 = parseInt(totalgaji) + parseInt(totaltambahtunjangan)
                ...
                var jumlahfix3 = parseInt(totalgajisangatfix) + parseInt(totaltambahtunjangan)
                $('#gaji_diterima').val(jumlahfix3)
            ...
            var jumlahfix3 = parseInt(totalgajisangatfix1) + parseInt(totaltambahtunjangan)
            $('#gaji_diterima').val(jumlahfix3)
            ...
            var jumlahfix3 = parseInt(totalgajisangatfix2) + parseInt(totaltambahtunjangan)
            $('#gaji_diterima').val(jumlahfix3)
